  ...
  return (
    <>
      ...
      {isSmallOpen && (
        <div
          onClick={close}
          className="lg:hidden fixed inset-0 z-[666] bg-secondary-dark opacity-50"
        />
      )}
      <aside
        ...
        ${isSmallOpen ? "flex z-[666] bg-white max-h-screen" : "hidden"}
        `}
      >
        <div className="lg:hidden pt-2 pb-4 px-2 sticky top-0 bg-white">
          <HeaderFirstSection hidden={false} />
        </div>
        <LargeSidebarSection>
